...
const Nav: React.FC = () => {
    ...
    return (
        <nav className="fixed top-0 z-20 my-0 flex  h-16 w-full items-center justify-center border-b bg-white  px-6 py-4 transition  dark:border-neutral-800 dark:bg-black lg:px-16">
            <a
                href="#content"
            ...
            <div className="flex w-full  items-center justify-between">
                ...
                <div className="flex items-center justify-evenly text-primary dark:text-neutral-100 ">
                    {/* <span>
              <Link href="/">Home</Link>
            </span>
            <span>

...
=======
    <nav className="fixed top-0 z-50 my-0 flex  h-16 w-full items-center justify-center border-b bg-white  py-4 px-6 transition duration-200 dark:border-neutral-800 dark:bg-black lg:px-16">

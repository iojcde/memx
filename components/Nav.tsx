...
const Nav: React.FC = () => {
  return (
    <nav className="sticky top-0 z-30 flex justify-center items-center w-full px-4 py-4 my-0 mb-8 backdrop-filter backdrop-blur-lg bg-opacity-0 firefox:bg-opacity-90 dark:bg-[#111827] dark:firefox:bg-opacity-90 bg-white border-b border-primary">

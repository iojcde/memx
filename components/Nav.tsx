...
const Nav: React.FC = () => {
  return (
    <>
      ...
      <nav className="relative z-30 flex justify-center items-center w-full px-4 py-4 my-0 mb-8 backdrop-filter backdrop-blur bg-opacity-70 firefox:bg-opacity-90 firefox:bg-white dark:firefox:bg-black dark:bg-opacity-20 dark:firefox:bg-opacity-[85]   transition duration-100">

...
const Nav: React.FC = () => {
  return (<>
    <a href="#content" className="z-50 absolute -translate-y-12 focus:translate-y-3 ml-5 py-2 px-4 outline-none transition shadow-lg border rounded-md border-gray-200 dark:border-gray-500">
      Skip to content
    </a>

...
const processBacklinkItem = (text: string, title: string) => {
  ...
  return (
    <div
      className="mt-2 overflow-hidden overflow-ellipsis whitespace-nowrap rounded bg-[#f5f2f2] p-3 py-4 text-sm transition duration-200 dark:bg-neutral-900"

    ><Markdown content={text.replaceAll('[[', '**').replaceAll(']]', '**')} /></div>
  )
}

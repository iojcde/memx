...
const Layout = ({ children }) => (
  <div className="flex">
    <div
      ...
      className="thin-scrollbar sticky top-16 hidden shrink-0 border-r border-neutral-200 dark:border-neutral-800 lg:block"
    >
      <div className=" -ml-3 h-full overflow-y-scroll p-8 pl-16">
        <Sidebar tree={buildResearchTree(allResearch)} />
      </div>

import { Html, BlockContent, DefinitionContent, Paragraph, Code } from 'mdast'
...
import { FilePath, pathToRoot, slugTag, slugifyFilePath } from 'lib/path'
            ...
            if (opts.wikilinks) {
                ...
                src = src.replace(wikilinkRegex, (value, ...capture) => {
                    ...
                    if (rawFp?.match(externalLinkRegex)) {
                        return `${embedDisplay}[${displayAlias.replace(
                            /^\|/,
                            ``,
                        )}](${rawFp})`
                    }
